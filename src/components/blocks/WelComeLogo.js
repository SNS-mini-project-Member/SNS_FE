  ...
  return (
    <div className={classes.leftArea}>
      <div className={props.type == 'login' ? classes.imgWrap : classes.imgWrapSign}>
        <img className={classes.logoSize} src="https://firebasestorage.googleapis.com/v0/b/my-cdn-d39b2.appspot.com/o/logo.svg?alt=media&token=a15af25c-9a03-43a0-8bd1-e257635f7d58" />
      </div>
